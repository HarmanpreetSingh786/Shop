  ...
  return (
    <Layout>
      <div className="mt-10">
        ...
        <div className="">
          <h1
            className=" text-center mb-5 text-2xl font-semibold first-letter:uppercase"
                        ...
                        .filter((obj) => {
                          if (!filterPrice || filterPrice === "all") {
                            ...
                            const [min, max] = filterPrice
                              ...
                              .map(Number);
                            return (
                              parseFloat(obj.price) >= min &&
                              parseFloat(obj.price) <= max
                            );
                          }
                        })
                        .map((item, index) => {
                          ...
                          return (
                            <div key={index} className="p-4 w-full md:w-1/4">
                              <div
                                className="h-full border border-gray-300 rounded-xl overflow-hidden shadow-lg hover:shadow-gray-500 shadow-[inset_0_0_2px_rgba(0,0,0,0.9)]cursor-pointer"
                                onClick={() =>
